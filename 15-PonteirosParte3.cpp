...
O C++ não permite passar um array inteiro como um argumento para uma função.
No entanto, podemos passar um ponteiro para um array especificando o nome do array sem um índice.
...
// Essa é a maneira mais utilizada
